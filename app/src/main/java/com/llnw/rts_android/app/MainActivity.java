...
public class MainActivity extends AppCompatActivity {
    ...
    public LLNWConfiguration configuration;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = (LLVideoView) findViewById(R.id.videoView);
    ...
    private void initSubscriberClient() {
        ...
        try {
            ...
            configJsonObject.put("edgeHost", "rts-1-nrt.llnw.net");
...
//            configJsonObject.put("validationUrl", "https://subscribe-validator.rts.llnwi.net/mmddev001/auth/v2/llnw-test-001/?ci=100&cd=100&cf=1600000000&h=c0518fc5aa957b128147545dfe45cc0f");
    ...
    private void initPublisherClient() {
        ...
        JSONObject configJsonObject = new JSONObject();
        try {
            configJsonObject.put("app", "llseapac");
            configJsonObject.put("host", "rts-1-nrt.llnw.net");
            configJsonObject.put("edgeHost", "rts-1-nrt.llnw.net");
            configJsonObject.put("protocol", "https");
            configJsonObject.put("port", "443");
            configJsonObject.put("streamName", "ddoi-rtsv2-test");
            configJsonObject.put("username", "ddoi-rtsv2-test");
            configJsonObject.put("password", "Limelight123");
            configJsonObject.put("rendition", "3500");
//            configJsonObject.put("validationUrl", "https://subscribe-validator.rts.llnwi.net/mmddev001/auth/v2/llnw-test-001/?ci=100&cd=100&cf=1600000000&h=c0518fc5aa957b128147545dfe45cc0f");
